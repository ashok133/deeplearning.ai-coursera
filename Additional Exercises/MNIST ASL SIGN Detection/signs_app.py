...
def predict_sign():
    sign_instance = request.get_json(silent=True, force=True)

    unseen_base64 = sign_instance['base64_str']

    predicted_sign = save_and_predict(unseen_base64)

    prediction = {'prediction': str(predicted_sign)}
